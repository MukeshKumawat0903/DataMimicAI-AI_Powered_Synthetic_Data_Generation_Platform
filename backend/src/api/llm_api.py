...
try:
    from src.core.ai_assistance.explainability.llm_explainability_engine.baseline_guard import (
...
async def generate_explanation(request: ExplanationRequest = Body(...)):
    ...
    try:
        ...
        if request.use_rag:
            ...
            try:
                from src.core.ai_assistance.explainability.rag import augment_diagnostics_with_rules
